-- Trademark Keyword Research Layer foundation (WP-0)
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_trademark_aliases_entity_norm
    ON trademark_aliases(trademark_entity_id, normalized_alias);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_trademark_kw_entity_norm
    ON trademark_keyword_candidates(trademark_entity_id, normalized_keyword);
